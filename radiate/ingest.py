...
def read_file(file_path : str) -> str:
    ...
    """
     ...
     if path.suffix== ".txt":
        ...
        raise ValueError(f"Unsupported file type: {path.suffix}. Supported: .txt, .md, .pdf")
...
class DocumentIngester:
    ...
    def ingest_file(self, file_path: str, metadata: Dict[str, Any] = None) -> Dict[str, Any]:
        ...
        for idx, chunk in enumerate(chunks):
            embedding = self.radiate.get_embedding(chunk)
    ...
    def ingest_directory(self, directory_path: str, pattern: str = "*.txt") -> Dict[str, Any]:
        """
